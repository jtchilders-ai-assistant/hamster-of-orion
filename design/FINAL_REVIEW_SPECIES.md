...
| # | Race | Issue | Fix | Status |
|---|------|-------|-----|--------|
| 1 | Mice | Missing `research_field_bonuses.computers: 40` | Add field-specific bonus to match Meklar | ✅ FIXED |
| 2 | Mice | Missing `no_refit_costs: true` | Implement no-refit-cost ability | ✅ FIXED |
| 3 | Mice | AI should be Erratic (not stable researcher) | Lower `treaty_reliability`, add variance | ✅ FIXED |
| 4 | Mice | Missing Planetology -20% penalty | Add to research_field_bonuses | ✅ FIXED |
| 5 | Rabbits | Missing `research_field_bonuses.planetology: 40` | Add field-specific Planetology bonus | ✅ FIXED |
| 6 | Rabbits | AI aggression too low (0.2) for Aggressive Expansionist | Raise to ~0.5 | ✅ FIXED (raised to 0.55) |
| 7 | Hermit Crabs | No pollution mechanic | Implement `no_pollution_cost: true` | ✅ FIXED |
| 8 | Hermit Crabs | No terraforming restriction | Implement `cannot_terraform: true` | ✅ FIXED |
| 9 | Hermit Crabs | Missing Computers +20% | Add to research_field_bonuses | ✅ FIXED |
| 10 | Hermit Crabs | Missing -20% other fields | Add research penalties | ✅ FIXED |
| 11 | Hermit Crabs | AI is pacifist, should be Xenophobic | Raise diplomatic distrust, lower positive diplomacy scaling | ✅ FIXED (aggression 0.0→0.45, archetype xenophobic_expansionist) |
| 12 | Guinea Pigs | Missing Weapons +20% research | Add to research_field_bonuses | ✅ FIXED |
| 13 | Guinea Pigs | Missing Construction +20% research | Add to research_field_bonuses | ✅ FIXED |
| 14 | Ferrets | Diplomatic penalties too mild (only -10%) | Add blood enemy relationships or harsher diplomatic baseline | ✅ FIXED (diplomacy -10→-30, blood_enemies_all flag, starting_relations note) |
| 15 | Budgies | Missing Propulsion +40% research | Add `research_field_bonuses.propulsion: 40` | ✅ FIXED |
| 16 | Budgies | `declares_war_first: true` wrong for Honorable race | Change to `false`, lower aggression to ~0.3 | ✅ FIXED (declares_war_first: false, aggression 0.6→0.35) |
| 17 | Ants | AI archetype should be Industrialist, not Expansionist | Update strategy focus to production/factory-building | ✅ FIXED |
...
**Applied by:** Wesley (subagent fix-species-critical)

All 17 critical discrepancies from the "Should Fix" table above have been applied. Files updated:

- `species/mice.md` — Computers +40% field bonus, Planetology -20% penalty, No Refit Costs ability, Erratic AI personality
- `species/rabbits.md` — Planetology +40% field bonus, Aggressive Expansionist AI personality
- `species/hermit-crabs.md` — No Pollution Cost ability, Cannot Terraform restriction, Computers +20% / all others -20% research modifiers, Xenophobic AI personality
- `species/guinea-pigs.md` — Weapons +20% and Construction +20% research field bonuses
- `species/ferrets.md` — Diplomacy -30% (catastrophic), blood enemies all, Ruthless Militarist flavor
- `species/budgies.md` — Propulsion +40% field bonus, Honorable Militarist AI, declares_war_first removed
- `species/ants.md` — AI archetype changed to Industrialist
- `species/race-stats-complete.md` — All JSON blocks updated to match individual species files
